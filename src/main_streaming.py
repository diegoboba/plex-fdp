...
def run_streaming_etl_pipeline(lookback_days: int = 3, force_full_refresh: bool = False):
    ...
    try:
        ...
        load_results = streaming_extractor.extract_all_data_streaming(lookback_days=lookback_days, force_full_refresh=force_full_refresh)
...
if __name__ == "__main__":
    ...
    print(f"Running streaming ETL locally with lookback_days={args.lookback_days}, force_full_refresh={args.force_full_refresh}...")
    result = run_streaming_etl_pipeline(lookback_days=args.lookback_days, force_full_refresh=args.force_full_refresh)
    print(f"Local streaming ETL result: {result}")